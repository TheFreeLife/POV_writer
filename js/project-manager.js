    ...
    async createProjectCard(project, isMostRecent = false) {
        ...
        card.innerHTML = `
            ...
            <div class="project-card-actions">
                <button class="project-card-action-btn" data-action="edit" title="프로젝트 설정 / 수정" aria-label="프로젝트 수정">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path>
                    </svg>
                </button>
                <button class="project-card-action-btn delete-btn" data-action="delete" title="프로젝트 삭제" aria-label="프로젝트 삭제">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
